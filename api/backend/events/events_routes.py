...
#------------------------------------------------------------
# Return all detailed information about the events generated by the computer
...
#------------------------------------------------------------
# Get the badges the events with eventsId has acquired
@events.route('/events/<eventId>/participants', methods=['GET'])
def get_events_badges(eventId):
